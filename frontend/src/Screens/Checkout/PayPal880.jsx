  ...
  useEffect(() => {
    ...
    const initializePayPalButtons = () => {
      ...
      const paypalButtonContainer = document.getElementById(
        "paypal-container-HYHMJBLN8XYMG"
      );

      if (sdkLoaded && window.paypal) {
        window.paypal
          .HostedButtons({
            hostedButtonId: "HYHMJBLN8XYMG",
          })
          .render("#paypal-container-HYHMJBLN8XYMG");
    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center gap-5 mt-4 md:p-4">
        ...
        <div className="w-500px text-center p-4">
          <div id="paypal-container-HYHMJBLN8XYMG"></div>
